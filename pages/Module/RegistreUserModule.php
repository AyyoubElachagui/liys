	...
	<div class="header-page-registre">
		...
		<div class="header-right-registre">
            ...
            <table>
                ...
                <tr>
                    <td><label class="label-user-name" id="labelUserName">User name</label><input class="input-user-name " id="3" type="text" name="user" ></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><label class="label-level" id="labelLevel">Level</label><input class="input-level " id="10" type="text" name="level" value=""></td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td><input class="input-registre registreU" id="input-registre" type="submit" name="submit" value="Registre Now"></td>
                </tr>
            </table>
		</div>
	</div>
