...
<body>
    <div class="header-home">
      ...
      <section class="Hours" style="z-index: 999;margin-left: 45%;color: rgb(229,240,255);"></section>
    ...
    <!------------------------ End ------------------------>
              <div class="cours cours-pdf">
                  <h1 style="margin-left: 39%;">C++</h1>
                  <h2 style="margin-left: 34%;"> Cours et exercices corrigés </h2>
                  <iframe src="coursesPDF/www.cours-gratuit.com--CoursInformatique-id3045.pdf" width="100%" height="500px" ></iframe>
              </div>
