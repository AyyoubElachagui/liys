	...
	$cpt = 0;
				...
				if($rst = mysqli_query($con,$cmd)){
					while($row = mysqli_fetch_row($rst)) {
						...
						<p class="user-massege" ><?php echo $row[3];?><br><font style="font-size: 0.5rem;margin-top:0.5rem;padding-left:0.5rem;color : rgb(23,123,141); " id="<?php echo $cpt;?>"><?php echo $row[4]; ?></font></p>
						<?php
						}
